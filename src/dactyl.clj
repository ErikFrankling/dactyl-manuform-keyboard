...
(def ic-hole "the part that is cut out to create the space where the ic is"
  (translate [0 (/ ic-depth -2) (/ ic-border 2)]
             (union
              ...
              (translate [(- (/ ic-width 2) (/ ic-solder-width 2)) 0 (/ (+ ic-height ic-solder-height) -2)]
                         ic-solder-cube)
              (translate [(+ (/ ic-width -2) (/ ic-solder-width 2)) 0 (/ (+ ic-height ic-solder-height) -2)]
                         ic-solder-cube))))
...
(def ic-fixture-holder
  (union
   ...
   ;            (difference
   ;             (translate [0 (/ (+ trrs-depth ic-border) -2) 0]
   ;                        (cube (+ trrs-width (* ic-border 2)) (+ trrs-depth ic-border) (+ trrs-height ic-border)))
   ;
   ;             trrs-hole))))
